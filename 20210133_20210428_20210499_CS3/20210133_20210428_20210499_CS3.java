...
/// Overview: this file contains the implementation of the terminal class,
// the commands that the user can use on the terminal and the parser class
// that will parse the input command and divide it into commandName and args
